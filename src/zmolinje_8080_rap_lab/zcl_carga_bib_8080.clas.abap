CLASS zcl_carga_bib_8080 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_carga_bib_8080 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    data: lt_acc_categ type table of ztb_ac_cate_8080,
          lt_catego    type table of ztb_catego_8080,
          lt_clientes  type table of ztb_cliente_8080,
          lt_clnts_lib type table of ztb_cln_lib_8080,
          lt_libros    type table of ztb_libros_8080.
...
******** TABLA1 ********
    ...
    delete from ztb_ac_cate_8080.
    insert ztb_ac_cate_8080 from table @lt_acc_categ.
...
******** z349_catego ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_8080.
    insert ztb_catego_8080 from table @lt_catego.
...
******** z349_clientes ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_cliente_8080.
    insert ztb_cliente_8080 from table @lt_clientes.
...
******** z349_clnts_lib
    ...
    "Delete possible entries; insert new entries
    delete from ztb_cln_lib_8080.
    insert ztb_cln_lib_8080 from table @lt_clnts_lib.
...
******** z349_libros ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_8080.
    insert ztb_libros_8080 from table @lt_libros.
